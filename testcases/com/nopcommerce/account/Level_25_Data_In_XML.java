...
public class Level_25_Data_In_XML extends BaseTest {
    ...
    @Parameters({"firstName", "lastName", "email", "password", "browser"})
    @BeforeClass
    public void beforeClass(String firstName, String lastName, String email, String password, String browserName) {
        ...
        this.emailAddress = getRandomEmail();
    }
